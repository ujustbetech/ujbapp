...
/**
 * Generated class for the CompanyAggreementPage page.
 *
...
@Component({
  selector: 'page-company-aggreement',
  templateUrl: 'company-aggreement.html',
  styleUrls: ['company-aggreement.scss']
})
export class CompanyAggreementPage implements OnInit {
  role
  loading
  userId
  url: any
  ...
  ngOnInit() {
    console.log('ngOnInit CompanyAggreementPage')
  }
  async Accept() {
    let request = {
      userId: this.userId,
  ...
  inserErrorApi() {
    ...
    this.logError.screen = 'CompanyAggreementPage'
