...
/**
 * Generated class for the PartnerAggreementPage page.
 *
...
@Component({
  selector: 'page-partner-aggreement',
  templateUrl: 'partner-aggreement.html',
  styleUrls: ['partner-aggreement.scss']
})
export class PartnerAggreementPage implements OnInit {
  role
  loading
  userId
  url: any
  ...
  constructor(
    ...
    route.queryParams.subscribe((params: any) => {
      ...
      this.address =
        this.userInfo.address.flatWing + ',' + this.userInfo.address.location
  ...
  ngOnInit() {
    console.log('ngOnInit PartnerAggreementPage')
  }
  async Accept() {
    let request = {
      userId: this.userId,
  ...
  inserErrorApi() {
    ...
    this.logError.screen = 'PartnerAggreementPage'
